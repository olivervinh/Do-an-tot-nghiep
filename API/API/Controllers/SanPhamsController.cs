...
namespace API.Controllers
{
    ...
    public class SanPhamsController : Controller
    {
        ...
        //        {
        //            FileHelper.DeleteFileOnPathAsync(i.ImageName);
        //        }
        //        _context.ImageSanPhams.RemoveRange(images);
        //        foreach (var item in upload.files)
        //        {
        //            ImageSanPham imageSanPham = new ImageSanPham();
        //            _context.ImageSanPhams.Add(imageSanPham);
        //            imageSanPham.ImageName = await FileHelper.UploadImageAndReturnPathAsync((int)imageSanPham.Id, "product", item);
        ...
        //                ImageSanPham imageSanPham = new ImageSanPham();
        //                _context.ImageSanPhams.Add(imageSanPham);
        //                imageSanPham.ImageName = await FileHelper.UploadImageAndReturnPathAsync((int)imageSanPham.Id, "product", file);
        //                imageSanPham.IdSanPham = sanpham.Id;
        //                _context.ImageSanPhams.Update(imageSanPham);
        //                await _context.SaveChangesAsync();
        //            }
